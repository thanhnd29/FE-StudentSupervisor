...
export interface ICreateUserDto extends Omit<User, 'userId' | 'roleName' | 'adminId' | 'userName' | 'schoolAdminId' | 'roleId' | 'status'> {}
export interface IUpdateUserDto extends Omit<User, 'userId' | 'roleName' | 'adminId' | 'userName' | 'schoolAdminId' | 'roleId' | 'status'> {}
