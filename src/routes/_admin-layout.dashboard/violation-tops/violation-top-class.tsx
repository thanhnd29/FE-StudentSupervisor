...
const Page: React.FunctionComponent<PageProps> = () => {
  ...
  useEffect(() => {
    queryClient.invalidateQueries({
      queryKey: ['violation-top-class'],
    });
  }, [year, month, week, semesterName, queryClient]);

  useDocumentTitle('Top 3 lớp có số lượng vi phạm nhiều nhất');

  return (
    <div className="">
      <TableBuilder
        sourceKey="violation-top-class"
        title="Top 3 lớp có số lượng vi phạm nhiều nhất"
        columns={[
          {
            key: 'classId',
            title: 'ID',
        ...
        queryApi={() => dashboardApi.getClassesMostViolation(schoolId, year, semesterName, month, week)}
        extraButtons={
...
export const Route = createFileRoute('/_admin-layout/dashboard/violation-tops/violation-top-class')({
  component: Page,
})